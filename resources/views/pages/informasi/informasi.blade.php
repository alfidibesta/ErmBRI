                        ...
                        <div class="box-body table-responsive">
                            <table id="mentoring2" class="table table-striped table-hover table-condensed" role="grid">
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('public/assets/dokumen/informasi/Panduan_Penggunaan_EDC_UKO(VX520_VX675_C680).pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Panduan_Penggunaan_EDC_UKO_PAX(S900).pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Panduan_Penggunaan_EDC_UKO(_ICT220_IWL220).pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Panduan_Penggunaan_EDC_PAX(S800_S900_D210).pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Panduan_Penggunaan_EDC_BRILink_VERIFONE(C680_VX520).pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Panduan_Penggunaan_EDC_BRILink_INGENICO(_ICT220_IWL220_MOVE2500).pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Panduan_Penggunaan_EDC_Merchant_VERIFONE(C680_VX520_VX675).pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Panduan_Back_Date_Aktivasi_Brizzi.pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Panduan_Penggunaan_EDC_VX675.pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Panduan_Penggunaan_EDC_VERIFONE_C680.pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Panduan_Penggunaan_EDC_PAX.pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Panduan_Penggunaan_EDC_Ingenico.pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Cara_Pembayaran_PDAM_di_EDC_BRILink_update.pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/SE_Pengelolaan_EDC_S_07_DIR_ECH_01_2020.pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/User_Guide_Link_Aja_EDC_BRI.pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Mekanisme_Komplain_Top_Up_dan_Card_Replace_BRIZZI.pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Mekanisme_Pengalihan_EDC_Kerjasama_Program_Pemerintah_pada_EDC_Pro.pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/ba_.pdf') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Tatacara_Upload_BA_Pemasangan_EDC_Brilinks_dan_Mer.doc') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Tatacara_Create_Tiket_Replace_Via_MMS_Petugas_IT.docx') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href="{{ url('/assets/dokumen/informasi/Tatacara_Tindak_Lanjut_Ticket_Replace_Via_MMS_Petu.doc') }}">
                                            Download
                                        </a>
                                    </td>
                                ...
                                {{--                            @foreach($info as $i)--}}
                                {{--                                <tr role="row" class="even">--}}
                                {{--                                    <td style="word-wrap: break-word;">{{ $i->id}}</td>--}}
                                {{--                                    <td style="word-wrap: break-word;">{{ $i->informasi }}</td>--}}
                                {{--                                    <td style="word-wrap: break-word;"><a href="{{ $i->dokumen }}"> Dokumen</a></td>--}}
                                {{--                                    <td style="word-wrap: break-word;">{{ $i->tanggal }}</td>--}}
                                {{--                                </tr>--}}
                                {{--                            @endforeach--}}
                                </tbody>
                            </table>
