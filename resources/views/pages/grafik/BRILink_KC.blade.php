...
<div class="row">
    <div class="col">
        <h1 class="text-primary"><b>BRILink KC</b></h1>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <h2 class="card-title mb-0">Ranking Cabang</h2>
...
<div class="row">
    <div class="col grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="row row-cols-auto">
                    <div class="col-2 input-grup">
                        <h2 class="card-title mb-0">Data KC</h2>
                        <select class="btn btn-primary btn-block" id="inputGroupSelect01" style="font-size: 14px">
                            <option value="">Kediri</option>
                            <option value="">Blitar</option>
                            <option value="">Tulingagung</option>
                        </select>
                    </div>
                </div>
                <hr>
                <div class="card">
                    <div class="p-4 border-bottom bg-light">
                        <h4 class="card-title mb-0">Pencapaian Masing-Masing Item KC Kediri (%)</h4>
                    </div>
                    <div class="card-body">
                        <div class="chart-container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="p-4 border-bottom bg-light">
                                <h4 class="card-title mb-0">Time Series Ranking Cabang KC Kediri</h4>
                            </div>
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="p-4 border-bottom bg-light">
                                <h4 class="card-title mb-0">Ranking PAB</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button"
                                                        class="btn btn-icons btn-rounded btn-success"><i
