$(function () {
    ...
    if ($("#jawaraChart").length) {
        var jawaraChartCanvas = $("#jawaraChart")
            .get(0)
            .getContext("2d");
        var jawaraPieData = {
            datasets: [
        ...
        var jawaraChart = new Chart(jawaraChartCanvas, {
            type: "doughnut",
            data: jawaraPieData,
            options: jawaraPieOptions
        });
        document.getElementById(
            "jawara-chart-legend"
        ).innerHTML = jawaraChart.generateLegend();
    }
